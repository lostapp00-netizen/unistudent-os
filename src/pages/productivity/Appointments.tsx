          ...
          <div key={app.id} className="bg-white dark:bg-zinc-900 rounded-3xl p-5 border border-zinc-200 dark:border-zinc-800 shadow-sm flex flex-col group relative overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-2 pl-2">
              ...
              <div className="flex gap-1">
                <button onClick={() => openEdit(app)} className="p-1.5 text-zinc-400 hover:text-indigo-600 rounded-lg transition-colors">
                  <Edit2 size={16} />
                </button>
                <button onClick={() => deleteAppointment(app.id)} className="p-1.5 text-zinc-400 hover:text-rose-600 rounded-lg transition-colors">
                  <Trash2 size={16} />
                </button>
              </div>
            </div>
              ...
              <div className="mt-2 pl-2 flex flex-wrap gap-2 border-t border-zinc-100 dark:border-zinc-800 pt-2">
                {app.attachments.map(att => (
                  <a 
                    ...
                    className="inline-flex items-center gap-1 text-xs bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 px-2 py-1 rounded transition-colors"
