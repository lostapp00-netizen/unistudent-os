...
export function Landing() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 font-sans selection:bg-indigo-500 selection:text-white transition-colors" dir={isAr ? 'rtl' : 'ltr'}>
      
      {/* --- TOP NAVBAR --- */}
      <header className="sticky top-0 z-50 bg-white/85 dark:bg-zinc-950/85 backdrop-blur-md border-b border-zinc-200/80 dark:border-zinc-800/80 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          
          {/* Logo */}
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-indigo-600 via-indigo-600 to-indigo-500 text-white flex items-center justify-center font-black text-xl shadow-lg shadow-indigo-600/25 group-hover:scale-105 transition-transform">
              U
            </div>
            <div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="p-2.5 rounded-2xl bg-zinc-100 dark:bg-zinc-900 hover:bg-zinc-200 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 transition-all border border-zinc-200 dark:border-zinc-800 shadow-2xs"
            ...
            <button
              ...
              className="px-3 py-2 rounded-2xl bg-zinc-100 dark:bg-zinc-900 hover:bg-zinc-200 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 text-xs font-black transition-all border border-zinc-200 dark:border-zinc-800 shadow-2xs uppercase tracking-wider"
            >
              {isAr ? 'EN' : 'عربي'}
            </button>
            ...
            <Link
              to="/auth"
              className="hidden sm:inline-flex items-center gap-1.5 px-4 py-2.5 rounded-2xl text-xs font-bold text-zinc-700 dark:text-zinc-200 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-all"
            >
              <LogIn size={15} />
            ...
            <Link
              to="/auth?mode=signup"
              className="inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 rounded-2xl bg-gradient-to-r from-indigo-600 via-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-600 text-white text-xs sm:text-sm font-bold shadow-lg shadow-indigo-600/25 transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
              <UserPlus size={15} />
      ...
      <section className="relative pt-12 pb-20 sm:pt-20 sm:pb-28 overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] sm:w-[900px] h-[400px] bg-gradient-to-tr from-indigo-500/15 via-blue-500/10 to-purple-500/10 blur-[130px] rounded-full pointer-events-none -z-10" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          
          {/* Pill Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-50 dark:bg-indigo-950/60 border border-indigo-200/80 dark:border-indigo-800/80 text-indigo-700 dark:text-indigo-300 text-xs sm:text-sm font-black shadow-xs animate-bounce-short">
            <Sparkles size={16} className="text-indigo-600 dark:text-indigo-400" />
            <span>{isAr ? 'المنصة الأكاديمية والإنتاجية الأولى لطلاب الجامعات • 100% مجاناً' : 'The #1 All-in-One University OS • 100% Free Forever'}</span>
          </div>

          {/* Main Headline */}
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight max-w-4xl mx-auto leading-[1.2] text-zinc-900 dark:text-white">
            {isAr ? (
              <>
          ...
          {/* Subtitle */}
          <p className="text-sm sm:text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed font-medium">
            {isAr 
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 pt-2">
            <Link
              to="/auth?mode=signup"
              className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white font-black text-sm sm:text-base shadow-xl shadow-indigo-600/30 transition-all flex items-center justify-center gap-2.5 hover:scale-[1.02]"
            >
            ...
            <a
              href="#simulator"
              className="w-full sm:w-auto px-6 py-4 rounded-2xl bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-800 text-zinc-800 dark:text-zinc-200 font-bold text-sm sm:text-base border border-zinc-200 dark:border-zinc-800 transition-all flex items-center justify-center gap-2 shadow-xs"
            >
          ...
          {/* Trust Badges */}
          <div className="pt-4 flex flex-wrap items-center justify-center gap-4 sm:gap-8 text-xs font-bold text-zinc-500 dark:text-zinc-400">
            <div className="flex items-center gap-1.5">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>{isAr ? 'يعمل بسلاسة على كافة الأجهزة' : 'All Devices Supported'}</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Award size={16} className="text-blue-500" />
              <span>{isAr ? 'يدعم كافة التخصصات والجامعات' : 'Universal Credit System'}</span>
            </div>
          </div>

          {/* --- HERO LIVE APP PREVIEW MOCKUP --- */}
          <div className="pt-8 sm:pt-12 max-w-5xl mx-auto">
            <div className="relative rounded-3xl p-3 sm:p-4 bg-gradient-to-b from-indigo-500/20 via-zinc-200/40 to-transparent dark:from-indigo-500/20 dark:via-zinc-800/40 dark:to-transparent border border-zinc-200/80 dark:border-zinc-800/80 shadow-2xl backdrop-blur-xl">
              
              <div className="bg-white dark:bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-200 dark:border-zinc-800 shadow-inner">
                ...
                <div className="p-4 bg-zinc-50 dark:bg-zinc-950 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-black text-zinc-400 ml-2">UniStudent OS Dashboard</span>
                  </div>

                  <div className="flex items-center gap-2">
                    <span className="px-3 py-1 rounded-full text-[11px] font-black bg-emerald-100 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800">
                      CGPA: 3.82 / 4.00 (امتياز)
                    </span>
                  </div>
                </div>

                {/* Mock Dashboard Grid */}
                <div className="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5 text-left rtl:text-right">
                  
                  {/* Card 1: Academic Engine Dial */}
                  <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-indigo-50/80 to-white dark:from-indigo-950/30 dark:to-zinc-900 border border-indigo-100 dark:border-indigo-900/40 space-y-3">
                    ...
                    <div>
                      <div className="text-3xl font-black text-indigo-600 dark:text-indigo-400">3.82</div>
                  ...
                  <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-emerald-50/80 to-white dark:from-emerald-950/30 dark:to-zinc-900 border border-emerald-100 dark:border-emerald-900/40 space-y-3">
                    <div className="flex items-center justify-between">
                    ...
                    <div>
                      <div className="text-2xl font-black text-emerald-600 dark:text-emerald-400">
                        {isAr ? 'سليم ومستقر 100%' : 'Safe & In Good Standing'}
                      </div>
                      <p className="text-[11px] text-zinc-500 mt-1">
                        {isAr ? '0 إنذارات • كافة المواد فوق معدل الأمان' : '0 warnings • all courses on target'}
                      </p>
                    </div>
                    <div className="flex items-center gap-1.5 text-[11px] font-bold text-emerald-700 dark:text-emerald-300 bg-emerald-100/70 dark:bg-emerald-900/30 p-2 rounded-xl">
                      <Check size={14} />
                      <span>{isAr ? 'مؤهل لمرتبة الشرف' : 'Eligible for Academic Honors'}</span>
                    </div>
                  </div>

                  {/* Card 3: Productivity Kanban Preview */}
                  <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-purple-50/80 to-white dark:from-purple-950/30 dark:to-zinc-900 border border-purple-100 dark:border-purple-900/40 space-y-3">
                    <div className="flex items-center justify-between">
                    ...
                    <div className="space-y-2">
                      <div className="p-2 bg-white dark:bg-zinc-800/80 rounded-xl border border-zinc-200/80 dark:border-zinc-700/60 flex items-center justify-between text-xs">
                        <span className="font-bold text-zinc-800 dark:text-zinc-200">{isAr ? 'مشروع مادة الخوارزميات' : 'Algorithms Project'}</span>
                        <span className="px-2 py-0.5 rounded-md text-[10px] font-black bg-rose-100 dark:bg-rose-900/40 text-rose-600">
                          {isAr ? 'غداً' : 'Tomorrow'}
                        </span>
                      </div>
                      <div className="p-2 bg-white dark:bg-zinc-800/80 rounded-xl border border-zinc-200/80 dark:border-zinc-700/60 flex items-center justify-between text-xs">
                        <span className="font-bold text-zinc-800 dark:text-zinc-200">{isAr ? 'تلخيص المحاضرة الخامسة' : 'Lecture 5 Summary'}</span>
                        <span className="px-2 py-0.5 rounded-md text-[10px] font-black bg-emerald-100 dark:bg-emerald-900/40 text-emerald-600">
                          {isAr ? 'منجز' : 'Done'}
                        </span>
                      </div>
                    </div>
      ...
      <section id="features" className="py-20 bg-white dark:bg-zinc-900/50 border-y border-zinc-200 dark:border-zinc-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-7">
            ...
            {/* Pillar 1 */}
            <div className="bg-zinc-50 dark:bg-zinc-900 p-6 sm:p-7 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-xs hover:border-indigo-300 dark:hover:border-indigo-700/60 transition-all space-y-4">
            ...
            {/* Pillar 6 */}
            <div className="bg-zinc-50 dark:bg-zinc-900 p-6 sm:p-7 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-xs hover:border-indigo-300 dark:hover:border-indigo-700/60 transition-all space-y-4">
              <div className="w-12 h-12 rounded-2xl bg-amber-100 dark:bg-amber-900/50 text-amber-600 dark:text-amber-400 flex items-center justify-center">
                <HardDrive size={24} />
              </div>
              <h4 className="text-lg font-bold text-zinc-900 dark:text-white">
      ...
      <section id="simulator" className="py-20 relative">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-xl overflow-hidden p-6 sm:p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
              ...
              <div className="lg:col-span-2 space-y-3">
                <div className="space-y-2">
                  {demoSubjects.map((sub) => (
                    <div 
                      key={sub.id}
                      className="p-3.5 sm:p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-800/60 border border-zinc-200/80 dark:border-zinc-700/60 flex flex-wrap sm:flex-nowrap items-center justify-between gap-3"
                    >
                      <div className="flex-1 min-w-[150px]">
                        <p className="font-bold text-sm text-zinc-900 dark:text-white">{sub.name}</p>
                        <p className="text-[11px] text-zinc-400">{sub.credits} {isAr ? 'ساعات معتمدة' : 'Credits'}</p>
                      </div>

                      <div className="flex items-center gap-3">
                        <div className="flex items-center gap-1.5">
                          <span className="text-xs text-zinc-400 font-bold">{isAr ? 'الساعات:' : 'Credits:'}</span>
                          <select
                            value={sub.credits}
                            onChange={(e) => updateDemoCredits(sub.id, Number(e.target.value))}
                            className="px-2 py-1 bg-white dark:bg-zinc-700 border border-zinc-200 dark:border-zinc-600 rounded-lg text-xs font-bold"
                          >
                            {[1, 2, 3, 4, 5].map(c => (
                        ...
                        <div className="flex items-center gap-1.5">
                          <span className="text-xs text-zinc-400 font-bold">{isAr ? 'التقدير:' : 'Grade:'}</span>
                          <select
                            value={sub.grade}
                            onChange={(e) => updateDemoGrade(sub.id, e.target.value)}
                            className="px-2.5 py-1 bg-indigo-50 dark:bg-indigo-950/60 border border-indigo-200 dark:border-indigo-800 rounded-lg text-xs font-black text-indigo-700 dark:text-indigo-300"
                          >
                            {gradeOptions.map(g => (
              ...
              {/* Result Dial Widget */}
              <div className="bg-gradient-to-br from-indigo-600 via-indigo-600 to-indigo-700 text-white rounded-3xl p-6 sm:p-8 text-center space-y-4 shadow-xl shadow-indigo-600/30 flex flex-col justify-center items-center">
                <div className="w-14 h-14 rounded-2xl bg-white/10 backdrop-blur-md flex items-center justify-center font-black">
                  <Award size={28} />
                </div>
                
                <div>
                  <span className="text-xs font-bold uppercase tracking-wider text-indigo-200">{isAr ? 'المعدل المحسوب' : 'Calculated GPA'}</span>
                  <div className="text-5xl sm:text-6xl font-black mt-1">{demoGpa}</div>
                ...
                <div className="pt-2 w-full">
                  <Link
                    to="/auth?mode=signup"
                    className="w-full py-3 px-4 rounded-xl bg-white text-indigo-700 hover:bg-indigo-50 font-black text-xs sm:text-sm transition-all flex items-center justify-center gap-2 shadow-md"
                  >
          ...
          <div className="space-y-3">
            {faqs.map((faq, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 overflow-hidden transition-all"
                >
                  <button
                    onClick={() => setFaqOpen(isOpen ? null : idx)}
                    className="w-full p-4 sm:p-5 flex items-center justify-between text-left rtl:text-right font-bold text-sm sm:text-base text-zinc-900 dark:text-white gap-3 hover:bg-zinc-100/50 dark:hover:bg-zinc-800/40 transition-colors"
                  >
                    <span className="flex items-center gap-2.5">
                      <HelpCircle size={18} className="text-indigo-600 dark:text-indigo-400 shrink-0" />
                      <span>{faq.q}</span>
                    </span>
                    <ChevronDown size={18} className={`text-zinc-400 transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`} />
                  </button>

                  {isOpen && (
                    <div className="px-5 pb-5 pt-1 text-xs sm:text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed border-t border-zinc-100 dark:border-zinc-800/60 font-medium">
                      {faq.a}
                    </div>
                  )}
                </div>
      ...
      <section className="py-16 sm:py-20 relative">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl bg-gradient-to-r from-indigo-900 via-indigo-900 to-indigo-950 text-white p-8 sm:p-14 text-center space-y-6 shadow-2xl relative overflow-hidden border border-indigo-800/50">
            ...
            <div className="relative z-10 pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                to="/auth?mode=signup"
                className="w-full sm:w-auto px-8 py-3.5 rounded-2xl bg-white text-indigo-900 hover:bg-indigo-50 font-black text-sm transition-all shadow-lg flex items-center justify-center gap-2 hover:scale-[1.02]"
              >
              ...
              <Link
                to="/auth"
                className="w-full sm:w-auto px-6 py-3.5 rounded-2xl bg-indigo-800/60 hover:bg-indigo-800 text-white font-bold text-sm border border-indigo-700 transition-all flex items-center justify-center gap-2"
              >
                <LogIn size={16} />
                <span>{isAr ? 'تسجيل الدخول' : 'Sign In'}</span>
              </Link>
      ...
      {/* --- FOOTER --- */}
      <footer className="py-10 bg-white dark:bg-zinc-950 border-t border-zinc-200 dark:border-zinc-800 text-xs text-zinc-500 dark:text-zinc-400">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-lg bg-indigo-600 text-white flex items-center justify-center font-bold text-xs">U</div>
