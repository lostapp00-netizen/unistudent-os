      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        ...
        <div className="flex flex-wrap gap-3 items-center relative">
          <div ref={filterPopoverRef} className="relative">
            ...
            {showFilterPopover && (
              <div className="absolute right-0 rtl:right-auto rtl:left-0 top-full mt-2 w-72 max-w-[calc(100vw-2rem)] bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-800 p-4 z-40">
