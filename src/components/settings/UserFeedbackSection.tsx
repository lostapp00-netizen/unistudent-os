...
import { MessageSquarePlus, Send, CheckCircle2, AlertCircle, Clock, Check, Sparkles, Inbox } from 'lucide-react';
...
export function UserFeedbackSection() {
  ...
  const getTypeLabel = (t: FeedbackSuggestion['type']) => {
    switch (t) {
      ...
      case 'bug':
        return isAr ? 'إبلاغ عن خطأ' : 'Bug Report';
      case 'other':
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value="complaint">{isAr ? '⚠️ شكوى / مشكلة' : 'Complaint'}</option>
